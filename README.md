# cody-api
Бесплатное безлимитное api ии моделей

> Drop-in замена OpenAI SDK: поменяйте **две строки** — и пользуйтесь более, чем 30 ии моделями без жестких лимитов и оплаты.
...
| images.generate  | ✅ Полная поддержка  | Поддержка gpt-image-1, flux.1-kontext-pro, size  |
...
На данный момент **тестово поддерживается Cline и другие сервисы, требующие лишь api key, base url и model**, нужно вставить наш url в поле base_url, вставить api key и указать модель из списка

# Ограничения
**Сейчас rate limit = 10rpm и 5rps**. Если ситуация изменится, мы заблаговременно предупредим всех участников в нашем телеграм канале: https://t.me/codyapi.
